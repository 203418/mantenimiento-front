...
export const { loginUSer,deleteProcess,  addProcess, allProcesses, closeSesion, allPhases, addPhase, clearPhases, addPhaseToPhases, modifyPhase, deletePhase } = userSlice.actions;